// Imported from: https://github.com/dotnet/roslyn/blob/version-2.10.0/src/Workspaces/Core/Portable/Differencing/EditScript.cs
...
namespace Prem.Diff
{
    ...
    public sealed partial class EditScript<TNode>
    {
        ...
        private readonly IReadOnlyCollection<Edit<TNode>> _edits;
        ...
        internal EditScript(Match<TNode> match)
        {
            ...
            _edits = edits.AsReadOnly();
        }

        public IReadOnlyCollection<Edit<TNode>> Edits => _edits;
